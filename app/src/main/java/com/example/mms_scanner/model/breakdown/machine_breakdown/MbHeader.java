package com.example.mms_scanner.model.breakdown.machine_breakdown;

import com.example.mms_scanner.model.breakdownqueue.breakdownqueue_exception.Lines;
...
public class MbHeader {
    ...
    public Boolean getMechanicConfirm() {
        return isMechanicConfirm;
    }

    public void setMechanicConfirm(Boolean mechanicConfirm) {
        isMechanicConfirm = mechanicConfirm;
    }

    public Boolean getSupvConfirm() {
        return isSupvConfirm;
    }

    public void setSupvConfirm(Boolean supvConfirm) {
        isSupvConfirm = supvConfirm;
    }
