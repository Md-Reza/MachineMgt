...
public class Repairs_CompleteList_Fragment extends Fragment {
    ...
    RecyclerView completeList_recycaler_view, breakdown_exceptionQueueRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_repairs__complete_list_, container, false);
    ...
    private void machineBreakdown() {
        try {
            spotsDialog.show();
            Call<List<MCBreakdownReport>> MachineBreakdownCall = retrofitApiInterface.getCompleteListDateBySection("Bearer" + " " + uToken, fromDate, toDate, section_Id);
