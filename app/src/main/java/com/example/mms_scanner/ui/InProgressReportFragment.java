...
public class InProgressReportFragment extends Fragment {
    ...
    RecyclerView inprogressList_recycaler_view, breakdown_exceptionQueueRecyclerView, lineRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_in_progress_report, container, false);
    ...
    private void machineBreakdown() {
        btnShow.setOnClickListener(v -> {
            ...
            try {
                spotsDialog.show();
                Call<List<MachineBreakdownQueue>> MachineBreakdownCall = retrofitApiInterface.getInCompleteListDateLine("Bearer" + " " + uToken, date, lineId);
    ...
    public class MachineBreakdownQueueAdapter extends RecyclerView.Adapter<MachineBreakdownQueueAdapter.ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(@NonNull MachineBreakdownQueueAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            try {
                holder.machineCodeQueueTxt.setText(String.valueOf("  Machine Code : " + machineBreakdownQueue.getMachineCode()));
            } catch (NullPointerException e) {
                e.printStackTrace();
            }

            try {
                holder.ShortCode.setText(machineBreakdownQueue.getMachineInfo().getShortCode());
            } catch (NullPointerException e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                try {
                    ...
                    holder.txtCompleteDatetime.setText(result_reqDT);
                } catch (ParseException e) {
                    e.printStackTrace();
                }
            } catch (NullPointerException e) {
            ...
            try {
                holder.Duration.setText(machineBreakdownQueue.getDuration());
            } catch (NullPointerException e) {
                e.printStackTrace();
            }

            try {
                String repBy = machineBreakdownQueue.getRepairBy();
                if (repBy.isEmpty()) {
                    holder.txtRepairBy.setText("Repair Start By: ");
                }
                if (repBy.equals("null")) {
                    holder.txtRepairBy.setText("Repair Start By: ");
                } else
                    holder.txtRepairBy.setText("Repair Start By: " + machineBreakdownQueue.getRepairBy());
            } catch (NullPointerException e) {
                e.printStackTrace();
            }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            CardView itemLayout;
            TextView machineCodeQueueTxt, ShortCode, CategoryName, RequestTimeQueueTxt, RequestTimeQueue,
                    StartTime, EndTime, Duration, txtCompleteDatetime, Status, txtRepairBy;
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                machineCodeQueueTxt = itemView.findViewById(R.id.txtMachineCode);
