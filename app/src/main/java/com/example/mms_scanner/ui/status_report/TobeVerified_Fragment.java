...
public class TobeVerified_Fragment extends Fragment {
    ...
    RecyclerView tobeVerifiedList_recycaler_view, breakdown_exceptionQueueRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_tobe_verified_, container, false);
        ...
        tobeVerifiedList_recycaler_view = root.findViewById(R.id.tobeVerifiedList_recycaler_view);
    ...
    private void machineBreakdown() {
        try {
            spotsDialog.show();
            Call<List<MCBreakdownReport>> MachineBreakdownCall = retrofitApiInterface.gettoBeVerfiedListDateBySection("Bearer" + " " + uToken, fromDate, toDate, section_Id);
                    ...
                    try {
                        if (response.isSuccessful()) {
                            if (response.body() != null) {
                                ...
                                tobeVerifiedList_recycaler_view.setHasFixedSize(true);
                                LinearLayoutManager mLayoutManager = new LinearLayoutManager(getContext());
                                tobeVerifiedList_recycaler_view.setLayoutManager(mLayoutManager);
                                tobeVerifiedList_recycaler_view.setAdapter(machineBreakdownAdapter);
    ...
    public class MachineBreakdownQueueAdapter extends RecyclerView.Adapter<MachineBreakdownQueueAdapter.ViewHolder> implements Filterable {
        ...
        public MachineBreakdownQueueAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = inflater.inflate(R.layout.tobe_verified_recycalerview, parent, false);
        ...
        public void onBindViewHolder(@NonNull MachineBreakdownQueueAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            try {
                holder.downTimeDuration.setText(machineBreakdownQueue.getAcceptanceDuration());
            } catch (NullPointerException e) {
                e.printStackTrace();
            }
    ...
    private void breakdownQueueException() {
        try {
            spotsDialog.show();
            Call<List<BreakdownQueueException>> BreakdownQueueExceptionCall = retrofitApiInterface.getBreakdownRepairQueueException("Bearer" + " " + uToken, MbhId);
